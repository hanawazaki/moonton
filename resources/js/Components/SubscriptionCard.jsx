...
const SubscriptionCard = ({ id, name, price, durationInMonth, features, onSelectSubscription, isPremium }) => {
  return (
    <>
      {/* <!-- Basic --> */}
      {!isPremium && (
        <div
          ...
          <div onClick={onSelectSubscription}>
            <Button type='button' href="payment_status/failed.html" variant='white-outline'
